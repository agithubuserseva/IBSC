...
type_dict = dict()
eid = create_type("eid", type_dict, lower_bound=0, upper_bound=None)
cid = create_type("cid", type_dict, lower_bound=0, upper_bound=None)
tid = create_type("tid", type_dict, lower_bound=0, upper_bound=None)
amount = create_type("amount", type_dict, lower_bound=0, upper_bound= myamount)
time = create_type("time", type_dict, lower_bound=0, upper_bound=None)
