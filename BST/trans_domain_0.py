...
type_dict = dict()
eid = create_type("eid", type_dict, lower_bound=0, upper_bound=1)
cid = create_type("cid", type_dict, lower_bound=0, upper_bound=2)
tid = create_type("tid", type_dict, lower_bound=0, upper_bound=4)
amount = create_type("amount", type_dict, lower_bound=0, upper_bound= myamount)
time = create_type("time", type_dict, lower_bound=0, upper_bound=4)
