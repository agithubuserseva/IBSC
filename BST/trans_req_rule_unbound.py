...
from trans_domain_unbound import *
import time
...
rule_1 = AND(NOT(large_instance_report), large_instance_authorize, sss)
rule_2 = AND(large_instance_report, NOT(large_instance_authorize), sss)
rule_3 = AND(large_instance_report, large_instance_authorize, NOT(sss))

complete_rules = [r1, r2, r3, r4, r5, r6, r7, r8, r9, r10]
